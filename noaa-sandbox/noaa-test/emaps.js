...
USCities = [
	...
	{name: "San Francisco, CA", lat: 37.796,  lng: -122.398,  zone:  -8},
...
var redIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/012.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var yelIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/036.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var grnIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/078.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var bluIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/149.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var purIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/172.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var gryIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/215.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var whtIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/216.small.png', iconSize: [10, 17], iconAnchor: [4, 17] });
var bigIcon = new L.icon({ iconUrl: 'http://www.esrl.noaa.gov/gmd/grad/solcalc/red-dot.png',   iconSize: [32, 32], iconAnchor: [16, 32] });

/*
var cookee = GetCookie("lat")
var startLat = (cookee) ? cookee : "37.796"
cookee = GetCookie("lng")
var startLng = (cookee) ? cookee : "-122.398"
cookee = GetCookie("gmt")
var startZone = (cookee) ? cookee : "-7"
*/

var startLat = "37.796";
var startLng = "-122.398";
var startZone = "-7";
